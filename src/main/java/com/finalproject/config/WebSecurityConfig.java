...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .permitAll()
                .antMatchers("/companies/**", "/leaves","/company/**" , "/profile")
                ...
                .antMatchers("/check_in_out/**","/leaves/add/**", "/leaves/request/**", "/leaves", "/currency/**",  "/profile", "/activities", "/activities/mark-time/**", "/activities/request/add/**", "/activities/request/complete/**", "/change_password", "/user/profileUpdate")
                .hasAuthority("USER")
                .antMatchers("/login")
                .anonymous()
                .anyRequest()
